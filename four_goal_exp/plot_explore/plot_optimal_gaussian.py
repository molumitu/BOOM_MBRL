...
def plot_four_goal_trajectories_clean(
    ...
    # Draw only top_right directional arrow
    arrow_length = 0.8
    arrow_start_dist = 0.2
    goal_name = 'top_right'
    goal_info = GOAL_CONFIG[goal_name]
    ...
    # Plot only the optimal (shortest) trajectory to top_right
    goal_name = 'top_right'
    goal_info = GOAL_CONFIG[goal_name]
...
def main():
    ...
    output_path = "figures/explore/optimal_gaussian.png"
