...
def plot_four_goal_trajectories_clean(
    ...
    for goal_name, goal_info in GOAL_CONFIG.items():
        for traj in trajectories_by_goal[goal_name]:
            ...
            # Successful trajectories: solid line, higher alpha, thicker line
            ax.plot(traj_array[:, 0], traj_array[:, 1],
                    color=goal_info['color'], alpha=0.4, linewidth=2,
...
def generate_trajectories(
    ...
    angle_std = 0.8  # Standard deviation of noise
    max_angle_change = 0.1  # Maximum angle change per step (radians, ~8.6 degrees)
    ...
    for i in range(num_trajectories):
        ...
        # Random primary direction (0 to 2pi)
...
def main():
    ...
    output_path = "figures/explore/explore.png"
